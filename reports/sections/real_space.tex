...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{figures/single_transmon_truncation_final.pdf}%
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{figures/single_transmon_hamiltonian_comparison.pdf}%
...
\begin{subequations}
    \begin{align}
        \hat H_C &= \sum_{j, \sigma} \hbar \omega_q \hat b^\dag_{j\sigma} \hat b_{j\sigma} - U\hat b^\dag_{j\sigma}\hat b^\dag_{j\sigma}\hat b_{j\sigma}\hat b_{j\sigma}\nonumber\\
               ...
               &\quad-\sum_j \left(\hbar g_{C,1}\hat b^\dag_{j,A}\hat b^\dag_{j,B} + \hbar g_{C,2}\hat b^\dag_{j,B} \hat b^\dag_{j+1,A}+\text{h.c.} \right) \label{eq:capacitive_hamiltonian}\\
        %
